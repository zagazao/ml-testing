...
Zur Kommunikations aus Python ist es empfehlenswert einen Client zu schreiben, welcher Pythonfunktionen auf die entsprechenden Endpunkte mappt. Ein prototypischer 
